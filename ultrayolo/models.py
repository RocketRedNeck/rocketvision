from ultrayolo.utils.google_utils import *
from ultrayolo.utils.layers import *
from ultrayolo.utils.parse_config import *
...
# TODO: Make this download and gdrive interface portable!
def attempt_download(weights):
    ...
    if weights and not os.path.isfile(weights):
        ...
        if not (r == 0 and os.path.exists(weights) and os.path.getsize(weights) > 1E6):  # weights exist and > 1MB
            ...
            #os.remove(weights)  # remove partial downloads
